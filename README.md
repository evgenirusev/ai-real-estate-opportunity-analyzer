...
**How it works:** Collect property and market data through AI Deep Research prompts and physical property inspections, then feed it all into a master prompt that assesses the investment opportunity — giving you a score, risk rating, and BUY/PASS verdict.
